...
public:
	...
	void SetEdge(const ECGraphNode *pNode);
	void DeleteEdge(const ECGraphNode *pNode);					// set an edge by passing a node to serve as destination of edge
...
public:
	...
	//bool compareNodePtr(const ECGraphNode* a, const ECGraphNode* b);
